...
namespace Automobili.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Adress,Kontakt")] Buyer buyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Adress,Kontakt")] Buyer buyer)
        {
            if (ModelState.IsValid)
            {
